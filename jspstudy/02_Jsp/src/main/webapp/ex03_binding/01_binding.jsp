...
<body>
	...
	<%-- 
		2. 우선 순위
			1) 같은 이름의 속성이 서로 다른 영역에 저장된 경우 먼저 사용되는 우선 순위가 존재
			2) pageContext > request > session > application 순으로 우선 순위가 높다.
			3) 각 영역을 지정하는 표현 언어(EL)의 내장 객체가 존재
				(1) pageScope
				(2) requestScope
				(3) sessionScope
				(4) applicationScope
	...
	<%
		...
		pageContext.setAttribute("movie", "미나리");	// 우선 순위 높다.
	%>
