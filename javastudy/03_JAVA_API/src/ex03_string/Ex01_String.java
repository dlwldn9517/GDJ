...
public class Ex01_String {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 1. 문자열 동등 비교 (객체를 이용한 equals 메소드 호출)
		...
		boolean result3 = str5.equalsIgnoreCase(str6);		// Upper Case, Lower Case
		...
		String email = "dlwldn9517@naver.com";
		...
		// 주의! replaceAll() 메소드는 특정 문자열을 찾아서 변환하는 것이 아니다.
		String ip = "192.168.101.91";
		String replacedIp = ip.replaceAll(".", "_");	// 192_168_101_91 를 기대
		System.out.println(replacedIp);	// 모든 글자를 _로 바꾼다.
