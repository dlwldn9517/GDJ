...
public class JSONWriter {
	...
	public static void m3() {
		...
		String str = "{\"name\":\"손석구\",\"man\":true,\"age\":40,\"height\":178}";
	...
	public static void m4() {
		...
		String str = "[{\"name\":\"제임스\",\"age\":30},{\"name\":\"에밀리\",\"age\":28}]";
		
		JSONArray arr = new JSONArray(str);
		
		// 일반 for문
		for(int i = 0, length = arr.length(); i < length; i++) {		// length에 () 붙어서 메소드이고, 성능이 떨어진다.
