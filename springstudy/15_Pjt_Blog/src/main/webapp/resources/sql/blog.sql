DROP TABLE COMMENTS;    -- COMMENT를 사용할 수 없어서 뒤에 s 붙여서 네이밍
DROP TABLE BLOG;
...
(
    ...
    CONTENT CLOB,   -- 4000바이트 이상이 필요할 때
    HIT NUMBER NOT NULL,
...
(
    COMMENT_NO NUMBER NOT NULL,  -- GROUP_NO(SEQ.CURRVAL) 는 COMMENT_NO(SEQ.NEXTVAL)와 같은 번호 가지기로 함
    BLOG_NO NUMBER,
