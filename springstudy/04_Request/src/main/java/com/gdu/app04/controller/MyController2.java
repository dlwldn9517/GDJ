...
public class MyController2 {
	...
	/*
		...
		2. redirect
		return "redirect:/board/detail1";
		URL Mapping 값이 /board/detail인 새로운 요청으로 redirect 하시오.
	*/
	
	
	// 1. <a href="${contextPath}/board/detail1?title=공지사항&hit=10">전송</a>
	@GetMapping("detail1")
	public String detail1(HttpServletRequest request) {
		...
		return "redirect:/board/detail2?title=" + title + "&hit=" + hit;	// redirect : 새로운 요청을 /board/detail2?title=공지사항&hit=10 처리하시오.
	}
